...
public class CgUI extends javax.swing.JFrame implements IUnitLister,
		IStudentLister {
	private cgCTL ctl;
	private javax.swing.DefaultComboBoxModel unitManager_;
	private javax.swing.DefaultComboBoxModel studentManager_;
	float assignment1_;
	float assignment2_;
	float finalExam_;
	Integer studentID_;
	...
	public CgUI(cgCTL ctl) {
		this.ctl = ctl;
		unitManager_ = new javax.swing.DefaultComboBoxModel(new String[0]);
		studentManager_ = new javax.swing.DefaultComboBoxModel(new String[0]);
		initComponents();
		jComboBox1.setModel(unitManager_);
		jComboBox2.setModel(studentManager_);
		jlabel6.setText("");
	}
	...
	private void jComboBox2ItemStateChanged(java.awt.event.ItemEvent evt) {// GEN-FIRST:event_jComboBox2ItemStateChanged
		...
		if (evt.getStateChange() == java.awt.event.ItemEvent.SELECTED) {
			if (cS.equals((String) jComboBox2.getItemAt(0))) {
				...
				ctl.studentSelected(studentID_);
			} else {
	...
	private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
		assignment1_ = new Float(jTextField1.getText()).floatValue();
		assignment2_ = new Float(jTextField2.getText()).floatValue();
		finalExam_ = new Float(jTextField3.getText()).floatValue();
		//lblErrMsg.setText("");
		try {
			String s = ctl.checkGrade(assignment1_, assignment2_, finalExam_);
	...
	public void clearUnits() {
		unitManager_.removeAllElements();
		unitManager_.addElement("<none selected>");
		clearStudents();
	}

	public void addUnit(IUnit u) {
		unitManager_.addElement(u.getUnitCode());
	}
	...
	public void clearStudents() {
		studentManager_.removeAllElements();
		studentManager_.addElement("<none selected>");
	}

	public void addStudent(IStudent student) {
		studentManager_.addElement(student.getID().toString() + " : "
	...
	public void setRecord(IStudentUnitRecord record) {
        ...
        //Methods should be verbs, in mixed case with the first letter lowercase, with the first letter of each internal word capitalized. (refresh3 -> refresh3)
